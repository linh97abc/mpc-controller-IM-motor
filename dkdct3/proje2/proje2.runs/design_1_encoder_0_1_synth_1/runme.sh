...
HD_PWD='C:/Users/linh9/Desktop/src/proje2/proje2.runs/design_1_encoder_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_encoder_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_encoder_0_1.tcl
