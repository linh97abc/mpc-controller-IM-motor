...
HD_PWD='C:/Users/linh9/Desktop/src/test_ctrl/test_ctrl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Controler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Controler.tcl
