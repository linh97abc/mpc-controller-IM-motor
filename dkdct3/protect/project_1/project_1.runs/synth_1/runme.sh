...
HD_PWD='C:/Users/linh9/Desktop/src/protect/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log protect.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source protect.tcl
