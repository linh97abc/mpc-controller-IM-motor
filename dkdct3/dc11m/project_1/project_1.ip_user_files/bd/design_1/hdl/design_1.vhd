...
architecture STRUCTURE of design_1 is
  ...
  component design_1_usample_8_0 is
  port (
    clk : in STD_LOGIC;
    din : in STD_LOGIC_VECTOR ( 9 downto 0 );
    dout : out STD_LOGIC_VECTOR ( 9 downto 0 )
  );
  end component design_1_usample_8_0;
  ...
  signal ab2alphabeta_0_done : STD_LOGIC;
  ...
  signal usample_3_dout : STD_LOGIC_VECTOR ( 9 downto 0 );
  signal usample_4_dout : STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  signal usample_8_dout : STD_LOGIC_VECTOR ( 9 downto 0 );
...
begin
  PA(9 downto 0) <= usample_6_dout(9 downto 0);
  PB(9 downto 0) <= usample_7_dout(9 downto 0);
  PC(9 downto 0) <= usample_8_dout(9 downto 0);
  a_1 <= a;
  b_1 <= b;
  clk1 <= srcClk_0_clk1;
  i_miso_1 <= i_miso;
...
Controler_0: component design_1_Controler_0_0
     port map (
      ...
      PdRef(19 downto 0) => xlconstant_0_dout(19 downto 0),
      Pd_out(19 downto 0) => Controler_0_Pd_out(19 downto 0),
      Vdc(19 downto 0) => xlconstant_1_dout(19 downto 0),
...
usample_6: component design_1_usample_6_0
     port map (
      clk => clk_wiz_0_clk_out1,
      din(9 downto 0) => usample_3_dout(9 downto 0),
      dout(9 downto 0) => usample_6_dout(9 downto 0)
    );
usample_7: component design_1_usample_7_0
     port map (
      clk => clk_wiz_0_clk_out1,
      din(9 downto 0) => usample_4_dout(9 downto 0),
      dout(9 downto 0) => usample_7_dout(9 downto 0)
    );
usample_8: component design_1_usample_8_0
     port map (
      clk => clk_wiz_0_clk_out1,
      din(9 downto 0) => usample_5_dout(9 downto 0),
      dout(9 downto 0) => usample_8_dout(9 downto 0)
    );
