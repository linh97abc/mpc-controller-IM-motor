...
-- Date        : Thu Jan 09 11:11:47 2020
-- Host        : DESKTOP-T22NVQ5 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/linh9/Desktop/src/dc11m/project_1/project_1.srcs/sources_1/bd/design_1/ip/design_1_srcClk_0_0/design_1_srcClk_0_0_sim_netlist.vhdl
...
entity design_1_srcClk_0_0_srcClk is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_srcClk_0_0_srcClk : entity is "srcClk";
end design_1_srcClk_0_0_srcClk;

architecture STRUCTURE of design_1_srcClk_0_0_srcClk is
  ...
  signal sSample_i_1_n_0 : STD_LOGIC;
  signal sclk10k : STD_LOGIC;
  signal sclk10k_i_1_n_0 : STD_LOGIC;
  signal sclk10k_last : STD_LOGIC;
  signal sclk10k_reg_n_0 : STD_LOGIC;
...
\cnt[11]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
sSample_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
sSample_reg: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
sclk10k_last_reg: unisim.vcomponents.FDPE
    generic map(
      INIT => '0'
    )
        port map (
...
entity design_1_srcClk_0_0 is
  ...
  attribute NotValidForBitStream of design_1_srcClk_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_srcClk_0_0 : entity is "design_1_srcClk_0_0,srcClk,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_srcClk_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_srcClk_0_0 : entity is "srcClk,Vivado 2016.4";
end design_1_srcClk_0_0;

architecture STRUCTURE of design_1_srcClk_0_0 is
begin
U0: entity work.design_1_srcClk_0_0_srcClk
     port map (
      clk => clk,
      clk1 => clk1,
      rst => rst,
