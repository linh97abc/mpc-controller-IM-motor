...
HD_PWD='C:/Users/linh9/Desktop/src_dk_lockalman/do_dong/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log loc_iabc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source loc_iabc.tcl
