...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -log simulate.log
}
