...
#set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports direction]
#set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports led_speed]


##RGB LED 5 (Zybo Z7-20 only)
#set_property -dict {PACKAGE_PIN Y11 IOSTANDARD LVCMOS33} [get_ports clk_10k]
...
#set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { tx }]; #IO_L5N_T0_34 Sch=jd_n[1]
