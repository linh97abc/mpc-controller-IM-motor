...
HD_PWD='C:/Users/linh9/Desktop/src/dc11m/test_dodong/test_dodong.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC.tcl
